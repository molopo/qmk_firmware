...
/**
 * \brief Same as `ximi_cycle_pointer_default_dpi`, but do not write to
 * EEPROM.
 *
...
/**
 * \brief Same as `ximi_cycle_pointer_sniping_dpi`, but do not write to
 * EEPROM.
 *
 * This means that reseting the board will revert the value to the last
 * persisted one.
